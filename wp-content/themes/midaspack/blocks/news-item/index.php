<section class="mp-news-item">
    <div class="cont">
        ...
        <div>
            ...
            <h1>Про партнерство з MIDAS PACK буде писати тут, треба просто клікнути на блок і вас переадресує на цю
                сторінку</h1>
            <div class="mb-[35px] max-h-[430px] rounded-[10px] overflow-hidden">
                <img class="block w-full h-full object-cover"
                     src="<?php bloginfo('template_url'); ?>/assets/images/intro.jpg" alt="">
            </div>
            <div>
